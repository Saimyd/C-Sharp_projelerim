...

{
    public partial class Form1 : Form
    {
        ...
        {
            this.Text = "Akaryakýt Otomasyonu";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                fiyat_bilgileri[0] = Convert.ToString(F_benzin97);
            }
            catch (Exception)
            {
                textBox7.Text = "Hata";
            ...
            try
            {
                ...
                fiyat_bilgileri[0] = Convert.ToString(F_dizel);
            }
            catch (Exception)
            {
                textBox8.Text = "Hata";
            ...
            try
            {
                ...
                fiyat_bilgileri[0] = Convert.ToString(F_eurodizel);
            }
            catch (Exception)
            {
                textBox9.Text = "Hata";
            ...
            try
            {
                F_eurodizel = F_eurodizel + (F_eurodizel * Convert.ToDouble(textBox10.Text) / 100);
                fiyat_bilgileri[0] = Convert.ToString(F_eurodizel);
            }
            catch (Exception)
            {
